 ...
 */
public class UpcommingHotelFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup parent,
        ...
        final View view = layoutInflater.inflate(R.layout.fragment_upcomming_hotel, parent, false);
        ...
        hotelBookingsViewModel.getUpcomingLiveData(authorization,usertype,corporate_id).observe(this, new Observer<List<HotelBooking>>() {
            @Override
