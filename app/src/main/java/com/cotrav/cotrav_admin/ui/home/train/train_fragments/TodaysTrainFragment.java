...
import com.cotrav.cotrav_admin.adapter.train_adapter.TodaysTrainBookingAdapter;
...
public class TodaysTrainFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup parent,
        ...
        trainBookingsViewModel.InitTrainBookingViewModel(authorization,usertype,corporate_id);
        todaysBookings =new ArrayList<>();
        final View view = layoutInflater.inflate(R.layout.fragment_todays_train, parent, false);
        ...
        trainBookingsViewModel.getTodaysLiveData(authorization,usertype,corporate_id).observe(this, new Observer<List<TrainBooking>>() {
            @Override
                ...
                if (s.equals("No Bookings Available")) {
                    ...
                    Snackbar.make(view, s, Snackbar.LENGTH_LONG).setAction("try again", new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            swipeRefreshLayout.setRefreshing(true);
                            trainBookingsViewModel.refreshTodaysBooking(authorization,usertype,corporate_id);
                        }
                    }).show();
                }
            }
