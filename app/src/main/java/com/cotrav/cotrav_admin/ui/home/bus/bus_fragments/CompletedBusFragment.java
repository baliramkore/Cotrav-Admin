...
import com.cotrav.cotrav_admin.adapter.bus_adapter.CompletedBusBookingAdapter;
...
public class CompletedBusFragment extends Fragment   implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup parent,
       ...
       // userId =loginPref.getString("user_id","n");
        ...
        final View view = layoutInflater.inflate(R.layout.fragment_completed_bus, parent, false);
        ...
        busBookingsViewModel.getPastLiveData(authorization,usertype,corporate_id).observe(this, new Observer<List<BusBooking>>() {
            @Override
                ...
                if (s.equals("No Bus Booking Available")) {
                    ...
                    Snackbar.make(view, s, Snackbar.LENGTH_LONG).setAction("try again", new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            swipeRefreshLayout.setRefreshing(true);
                            busBookingsViewModel.refreshPastBooking(authorization,usertype,corporate_id);
                        }
                    }).show();
                }
            }
