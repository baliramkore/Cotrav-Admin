...
import com.cotrav.cotrav_admin.adapter.TrainTabAdapter;
import com.cotrav.cotrav_admin.ui.home.train.AddTrainBookingActivity;
import com.google.android.material.floatingactionbutton.FloatingActionButton;
import com.google.android.material.tabs.TabLayout;

public class ShowTrainBookingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ShowTrainBookingActivity.this, AddTrainBookingActivity.class);
